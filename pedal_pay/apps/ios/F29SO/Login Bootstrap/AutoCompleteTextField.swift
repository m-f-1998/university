...
open class AutoCompleteTextField: UITextField {
    ...
    weak var autoCompleteTextFieldDelegate: AutoCompleteTextFieldDelegate!
    ...
    convenience init(frame: CGRect, autoCompleteTextFieldDataSource dataSource: AutoCompleteTextFieldDataSource, autoCompleteTextFieldDelegate delegate: AutoCompleteTextFieldDelegate! = nil) {
