...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['session_id']) && isset($_POST['classID'])) {

        $db = new DbOperation();
        $res = $db->deleteClass($db->noHTML($_POST['session_id']), $db->noHTML($_POST['classID']));
        ...
        if ($res === -1) {
          ...
          $response['error'] = true;
          $response['message'] = 'This Class Is Not Registered Is Not Registered In The System';
