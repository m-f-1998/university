...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['session_id']) && isset($_POST['title']) && isset($_POST['link']) && isset($_POST['class'])) {

        $db = new DbOperation();
        $res = $db->uploadFile($db->noHTML($_POST['session_id']), $db->noHTML($_POST['title']), $db->noHTML($_POST['link']), $db->noHTML($_POST['class']));
