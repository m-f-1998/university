...
if ($_SERVER['REQUEST_METHOD' ] == 'POST') {
    ...
    if (isset($_POST['session_id']) && isset($_POST['title']) && isset($_POST['due']) && isset($_POST['class']) && isset($_POST['id'])) {

        $db = new DbOperation();
        $res = $db->updateEvent($db->noHTML($_POST['session_id']), $db->noHTML($_POST['title']), $db->noHTML($_POST['due']), $db->noHTML($_POST['class']), $db->noHTML($_POST['id']));
